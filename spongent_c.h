...
HashReturn SM_FUNC(kernel)  SpongentWrap(const BitSequence* key,
...
HashReturn SM_FUNC(kernel)  SpongentUnwrap(const BitSequence* key,
                                          const BitSequence* ad, DataLength adBitLength,
                                          const BitSequence* input, DataLength bitLength,
                                          BitSequence* output,
                                          const BitSequence* expectedTag);

HashReturn SM_FUNC(kernel)  SpongentMac(const BitSequence* key,
                                         const BitSequence* input, DataLength bitLength,
                                         BitSequence* mac);
