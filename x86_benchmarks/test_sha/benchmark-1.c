 ...
 #define SIZE_OF_STAT 10000 //100000 
 #define BOUND_OF_LOOP 1//1000 
 #define UINT64_MAX (18446744073709551615ULL) 
 
uint32_t message[1025], hash[32]; 
int aux[100];
...
for (j=0; j<BOUND_OF_LOOP; j++) { 
 ...
 /*call the function to measure here*/ SHA_2( message, 1024, &hash[0], 0x1); // change to 256, 512, 1024
